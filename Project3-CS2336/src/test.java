...
class test
{
    ...
    {
    	test TestTree = new test("datafile.txt"); 
        
    	// this is the index class call, the constructor takes the filename, keyword
    	// and gives the articles related to the keyword
    	Index test = new Index("dataFile.txt", "pruning");  
    }
}
